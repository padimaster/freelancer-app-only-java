...
public class UserRespositoryTest {
  ...
  public void setUp() {
    ...
    this.userTest = new UserEntity("111111", "John Doe", "john@mail.com", "123456");
  }
  ...
  public void shouldInsertUser() {
    ...
    assertTrue(this.userRespository.getAll().size() == initialRespositorySize + 1);
  ...
  public void shouldUpdateAllDataUser() {
    ...
    dataToUpdate = new UserEntity("444444", "Kenny Pinchao", "kenny@mail.com", "654321");
    userUpdated = this.userRespository.update(this.userTest.getId(), dataToUpdate);
